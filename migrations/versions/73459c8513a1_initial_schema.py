...
def upgrade():
    ...
    sa.Column('debt_type', sa.Enum('credit_card', 'split', 'mortgage'), nullable=False),
...
def downgrade():
    raise RuntimeError(
        'Destructive downgrade is disabled for the initial schema. '
        'Create an explicit data-preserving migration instead.'
    )
